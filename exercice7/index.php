...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Les formulaires, exercice 7 et 8</title>
    </head>
            ...
            <div class="tab-pane fade" id="connexion">
                ...
                <div class = "row justify-content-center">
                    <div class = "card mb-3">
                        ...
                        <img style = "height: 250px; width: 100%; display: block;" src = "assets/img/DiscoElysium.jpg" alt = "Card image">
                        <div class = "card-body">
